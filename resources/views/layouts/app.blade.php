...
<body class="bg-gray-100 dark:bg-gray-900">
    <div x-data="{ sidebarOpen: false, sidebarExpanded: true, showLogoutConfirm: false }">
        <aside :class="sidebarExpanded ? 'w-64' : 'w-16'"
            ...
            <div class="flex-1 overflow-y-auto scrollbar-thin scrollbar-thumb-orange-600 scrollbar-track-orange-900/30">
                ...
                <div class="flex items-center space-x-6">
                    ...
                    window.Echo.channel('notifications')
                        ...
                        <button @click="openNotif = !openNotif" class="relative">
                            <img :src="$store.theme.dark ? '{{ asset('assets/icons/notification_white.png') }}' :
                            ...
                            <!-- Badge -->
                            <span x-show="count > 0"
                                class="absolute -top-3 -right-3 min-w-[20px] h-[20px] flex items-center justify-center
