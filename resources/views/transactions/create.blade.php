...
@section('content')
    ...
    <div class="container px-6 mx-auto mt-8">
        ...
        <form action="{{ route('transactions.store') }}" method="POST" id="trx-form" class="bg-white p-6 rounded shadow">
            @csrf
            ...
            <h3 class="font-semibold mb-2">Journal Entries</h3>

            <div id="journal-entries" class="space-y-2">
                <div class="flex gap-2 journal-line items-center">
                    ...
                    <input type="number" step="0.01" name="journal[0][debit]" placeholder="Debit"
                        class="w-36 px-2 py-2 border rounded debit-input" />
                    <input type="number" step="0.01" name="journal[0][credit]" placeholder="Credit"
                        class="w-36 px-2 py-2 border rounded credit-input" />
            ...
            <div class="mt-3">
                <button type="button" id="add-line" class="px-3 py-2 bg-gray-700 text-white rounded">+ Add Line</button>
            </div>

            <div class="mt-4 flex items-center gap-6">
                <div>Total Debit: <span id="total-debit">0.00</span></div>
                <div>Total Credit: <span id="total-credit">0.00</span></div>
                <div id="balance-badge" class="px-3 py-1 rounded text-white bg-red-500">Unbalanced</div>
            </div>

            <div class="mt-4">
                <button id="submit-btn" type="submit" class="px-4 py-2 bg-green-600 text-white rounded" disabled>Save
                    Transaction</button>
            </div>
        </form>
    </div>
